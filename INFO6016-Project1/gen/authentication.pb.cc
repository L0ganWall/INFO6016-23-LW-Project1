...
const char descriptor_table_protodef_authentication_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "serId\030\002 \002(\003\"\330\001\n\027CreateAccountWebFailure\022"
  "\021\n\trequestId\030\001 \002(\003\022S\n\rfailureReason\030\002 \002("
  "\0162$.auth.CreateAccountWebFailure.reason:"
  "\026ACCOUNT_ALREADY_EXISTS\"U\n\006reason\022\032\n\026ACC"
  "OUNT_ALREADY_EXISTS\020\000\022\024\n\020INVALID_PASSWOR"
  "D\020\001\022\031\n\025INTERNAL_SERVER_ERROR\020\002\"N\n\017Authen"
  "ticateWeb\022\021\n\trequestId\030\002 \002(\003\022\r\n\005email\030\003 "
  "\002(\t\022\031\n\021plaintextPassword\030\001 \002(\t\"Q\n\026Authen"
  "ticateWebSuccess\022\021\n\trequestId\030\002 \002(\003\022\016\n\006u"
  "serId\030\003 \002(\003\022\024\n\014creationDate\030\001 \002(\t\"\272\001\n\026Au"
  "thenticateWebFailure\022\021\n\trequestId\030\002 \002(\003\022"
  "O\n\rfailureReason\030\001 \002(\0162#.auth.Authentica"
  "teWebFailure.reason:\023INVALID_CREDENTIALS"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_authentication_2eproto = {
  false, false, 742, descriptor_table_protodef_authentication_2eproto, "authentication.proto", 
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          goto handle_unusual;
        continue;
      // required .auth.CreateAccountWebFailure.reason failureReason = 2 [default = ACCOUNT_ALREADY_EXISTS];
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
...
::PROTOBUF_NAMESPACE_ID::uint8* AuthenticateWeb::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    ...
    target = stream->WriteStringMaybeAliased(
        1, this->_internal_plaintextpassword(), target);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* AuthenticateWebSuccess::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    ...
    target = stream->WriteStringMaybeAliased(
        1, this->_internal_creationdate(), target);
  }
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      // required .auth.AuthenticateWebFailure.reason failureReason = 1 [default = INVALID_CREDENTIALS];
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ::PROTOBUF_NAMESPACE_ID::uint64 val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* AuthenticateWebFailure::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000002u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteEnumToArray(
      1, this->_internal_failurereason(), target);
  }
